...
/* Any list that grows with the business scrolls inside its own box rather
   than stretching the page. One constant, so the tables can't drift to
   different heights and make the page look assembled by accident. */
export const SCROLL = "max-h-[28rem] overflow-auto";
/* Column headings stay put while the rows move under them. */
export const STICKY = "sticky top-0 z-10 bg-white dark:bg-slate-900";
